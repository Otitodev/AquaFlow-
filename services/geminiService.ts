...
export const getAIAssistance = async (message: string, history: { role: 'user' | 'model', text: string }[]) => {
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        systemInstruction: `You are CallBot, the friendly AI assistant for Callahan Pipe & Drain, based in Chicago.
        ...
        5. Encourage booking an appointment at callahanpipeanddrain.com.
